...
const tableData = [
  { stt: 1, info: { namHoc: '2025 - 2026', hocKy: 'Học kỳ 1', lop: 'Lớp 10A1' }, teacher: 'NGUYỄN THỊ VÂN', status: 'Chưa ký' },
];

const HomeroomTeacherSignatureView: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-50 bg-slate-100 overflow-y-auto p-4 sm:p-6 lg:p-8" aria-modal="true" role="dialog">
      <div className="w-full mx-auto relative max-w-screen-xl">
        ...
        <div className="mt-8">
            <h1 className="text-3xl font-bold text-slate-800 mb-6">GVCN ký số sổ theo dõi</h1>
...
export default HomeroomTeacherSignatureView;